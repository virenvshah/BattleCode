...
public class TroopManagement {
	 ...
	 */
	public void produceDifferentUnits(Factory factory, UnitType attacker) {
		if (factory.factoryCount % 2 == 1) {
	...
	public void initializeWorkers(GameController gc) {
   	...
   	unitCounter.workerCap = 10 + (initialKarbonite / 750);
