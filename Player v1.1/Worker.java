			 ...
			 // if worker can mine but no karbonite is available
				 ...
				 if (i==8){
					 ...
					 Tuple location = new Tuple(
							 mapLocation.getX(), mapLocation.getY());
					 minedOut.add(location);
					 System.out.println(mineLocs.get(0).toString() + " " + location.toString());
					 System.out.println(mineLocs.get(0).equals(location));
					 System.out.println(mineLocs.remove(location));
					 state = State.Idle;
					 pointToMine = 9;
				 }
			 }
