 ...
 *
 */
public class ReplicatingPlayer {
	...
	public static void main(String args[]) {
		int workerNum=0;
		ReplicatingPlayer fbp = new ReplicatingPlayer();
	      		...
	      		if (unit.unitType() == UnitType.Worker) {
	      			...
	      			if (worker == null) {
	      				...
	      				fbp.unitHashMap.put(worker.id, worker);
								workerNum++;
								System.out.println("worker number is :"+workerNum);
	      			}
							if (workerNum<5){ //our replication test
